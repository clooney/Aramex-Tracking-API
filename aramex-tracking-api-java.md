Aramex Tracking API - Java
================================
Use Java to track Aramex shipments with Aramex Tracking API.

Features
--------
- Real-time Aramex tracking.
- Batch Aramex tracking.
- Other features to manage your Aramex tracking.
...
Then, start to track your Aramex shipments.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.aramex;
    ...
    public class CreateAramexTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("aramex");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateAramexTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetAramexTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("aramex");
...
Update a tracking by ID:
    ...
    public class UpdateAramexTrackingExample {
